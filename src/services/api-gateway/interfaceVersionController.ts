...
/** 新增接口版本 POST /interfaces/versions */
export async function createInterfaceVersion(
  body: API.InterfaceVersionCreateDto,
  options?: { [key: string]: any }
) {
  return request<API.InterfaceVersionDto>("/interfaces/versions", {
    method: "POST",
    headers: {
...
/** 查询接口版本详情 根据 ID 查询接口版本详细信息 GET /interfaces/versions/${param0} */
...
/** 更新接口版本 POST /interfaces/versions/${param0} */
export async function updateInterfaceVersion(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.interfaceVersionUpdateParams,
...
/** 删除接口版本 DELETE /interfaces/versions/${param0} */
export async function deleteInterfaceVersion(
  ...
  const { id: param0, ...queryParams } = params;
  return request<any>(`/interfaces/versions/${param0}`, {
    method: "DELETE",
    params: { ...queryParams },
    ...(options || {}),
  });
...
/** 分页查询接口版本列表 根据条件分页查询接口版本列表 POST /interfaces/versions/search */
