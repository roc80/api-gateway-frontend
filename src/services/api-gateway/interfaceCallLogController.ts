...
/** 查询接口调用日志详情 根据 ID 查询接口调用日志详细信息 GET /api/interfaces/logs/${param0} */
export async function getById2(
  ...
  return request<API.InterfaceCallLogDto>(`/api/interfaces/logs/${param0}`, {
    method: "GET",
    params: { ...queryParams },
    ...(options || {}),
  });
